...
public class OpenStreetMapTileFilesystemProvider extends OpenStreetMapAsyncTileProvider {
	...
	public static final boolean IS_EMULATOR = 
		 android.provider.Settings.Secure.ANDROID_ID == "android_id" || true; 
	 ...
	 */
	public File getOutputFile(final OpenStreetMapTile tile) throws CantContinueException {
	...
	public void saveFile(final OpenStreetMapTile tile, final File outputFile, final byte[] someData) throws IOException{
	...
	private class TileLoader extends OpenStreetMapAsyncTileProvider.TileLoader {
		...
		public void loadTile(final OpenStreetMapTile aTile) throws CantContinueException {
			...
			if (!mSdCardAvailable) {
				...
				tileNotLoaded(aTile);
				throw new CantContinueException("No SD CARD");
